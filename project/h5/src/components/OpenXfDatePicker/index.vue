...
function setDate(type: number) {
  if (type === 1) {
    ...
    selectedValues.value = [date.format('YYYY'), date.format('MM'), date.format('DD')]
    selectedValues2.value = [dayjs().add(-1, 'day').format('YYYY'), dayjs().add(-1, 'day').format('MM'), dayjs().add(-1, 'day').format('DD')]
  }
  else if (type === 3) {
  ...
  if (type === 4 || type === 5) {
    selectedValues.value = [dayjs().add(-1, 'day').format('YYYY'), dayjs().add(-1, 'day').format('MM'), dayjs().add(-1, 'day').format('DD')]
    selectedValues2.value = [dayjs().add(-1, 'day').format('YYYY'), dayjs().add(-1, 'day').format('MM'), dayjs().add(-1, 'day').format('DD')]
  }
...
const isToday = computed(() => {
  return dayjs(selectedValues.value.join('-')).isSame(dayjs(), 'day') && dayjs(selectedValues2.value.join('-')).isSame(dayjs(), 'day')
})
</script>
