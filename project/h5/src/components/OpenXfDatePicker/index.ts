...
function createOpenXfDatePicker(config: OpenDatePickerOptions) {
  const {
    value,
    field,
    field2,
...
export function createXfDatePicker(params?: OpenDatePickerOptions) {
  return createOpenXfDatePicker(params)
}

export function openXfDatePicker(params?: OpenDatePickerOptions) {
  const { open } = createOpenXfDatePicker(params)
  open()
}
